...
Our second analytical approach uses the content of emails to determine the domain of communication. This approach is a natural and flexible way of accounting for the domain of communication, as emails about different domains will often use different words, and the words people use to talk about a particular domain will likely co-occur at a higher than chance rate. 
